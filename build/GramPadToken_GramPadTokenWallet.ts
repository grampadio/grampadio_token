...
export function dictValueParserGramPadTokenMaster$Data(): DictionaryValue<GramPadTokenMaster$Data> {
 ...
 type GramPadTokenWallet_init_args = {
    $$type: 'GramPadTokenWallet_init_args';
    balance: bigint;
    owner: Address;
    minter: Address;
...
function initGramPadTokenWallet_init_args(src: GramPadTokenWallet_init_args) {
    return (builder: Builder) => {
        const b_0 = builder;
        b_0.storeCoins(src.balance);
        b_0.storeAddress(src.owner);
...
async function GramPadTokenWallet_init(balance: bigint, owner: Address, minter: Address) {
    const __code = Cell.fromHex('');
    const builder = beginCell();
    initGramPadTokenWallet_init_args({ $$type: 'GramPadTokenWallet_init_args', balance, owner, minter })(builder);
    const __data = builder.endCell();
    return { code: __code, data: __data };
}

export const GramPadTokenWallet_errors = {
...
export const GramPadTokenWallet_errors_backward = {
    "Stack underflow": 2,
    "Stack overflow": 3,
    "Integer overflow": 4,
...
const GramPadTokenWallet_types: ABIType[] = [
...
const GramPadTokenWallet_opcodes = {
...
const GramPadTokenWallet_getters: ABIGetter[] = [
    {"name":"get_wallet_data","methodId":97026,"arguments":[],"returnType":{"kind":"simple","type":"JettonWalletData","optional":false}},
]

export const GramPadTokenWallet_getterMapping: { [key: string]: string } = {
    'get_wallet_data': 'getGetWalletData',
}

const GramPadTokenWallet_receivers: ABIReceiver[] = [
...
export class GramPadTokenWallet implements Contract {
    
    public static readonly storageReserve = 0n;
    public static readonly errors = GramPadTokenWallet_errors_backward;
    public static readonly opcodes = GramPadTokenWallet_opcodes;
    
    static async init(balance: bigint, owner: Address, minter: Address) {
        return await GramPadTokenWallet_init(balance, owner, minter);
    }
    
    static async fromInit(balance: bigint, owner: Address, minter: Address) {
        const __gen_init = await GramPadTokenWallet_init(balance, owner, minter);
        const address = contractAddress(0, __gen_init);
        return new GramPadTokenWallet(address, __gen_init);
    }
    
    static fromAddress(address: Address) {
        return new GramPadTokenWallet(address);
    }
    
    readonly address: Address; 
    readonly init?: { code: Cell, data: Cell };
    readonly abi: ContractABI = {
        types:  GramPadTokenWallet_types,
        getters: GramPadTokenWallet_getters,
        receivers: GramPadTokenWallet_receivers,
        errors: GramPadTokenWallet_errors,
    };
